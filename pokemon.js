...
fetch("pokedex.json")
    ...
    .then(pokedex => {
        ...
        //PROPERTIES DECLARATION OF EACH POKEMON CHARACTERS
        ...
        //STATS OF EVERY POKEMON CHARACTER
        ...
        $(".pokemon-page-gender").html(gender);

        //DISPLAYING STATS OF POKEMON CHAR
